	...
	public void draw(Graphics2D graphics2d) {
		...
		case "up": {
			...
			if (attacking == true) {
				...
				if (spriteNum == 2) { 
					damageAreaX1 = worldX + 24;
					damageAreaY1 = worldY - 30;
					damageAreaX2 = worldX + 33;
					damageAreaY2 = worldY;
					image = upAttack2;
				}
			}
		...
		case "down": {
			...
			if (attacking == true) {
				...
				if (spriteNum == 2) { 
					damageAreaX1 = worldX + 18;
					damageAreaY1 = worldY + 45;
					damageAreaX2 = worldX + 27;
					damageAreaY2 = worldY + 75;
					image = downAttack2;
				}
			}
			break;
		...
		case "left": {
			...
			if (attacking == true) {
				...
				if (spriteNum == 2) { 
					damageAreaX1 = worldX - 27;
					damageAreaY1 = worldY + 27;
					damageAreaX2 = worldX + 6;
					damageAreaY2 = worldY + 39;
					image = leftAttack2;
				}
			}
			break;
		...
		case "right": {
			...
			if (attacking == true) {
				...
				if (spriteNum == 2) { 
					damageAreaX1 = worldX + 42;
					damageAreaY1 = worldY + 27;
					damageAreaX2 = worldX + 72;
					damageAreaY2 = worldY + 36;
					image = rightAttack2;
				}
			}
			break;
		...
		if (skill1EffectiveTime == 3*60 || (skill1EffectiveTime < 0 && skill1waiting != 0)) {
			if (image == leftAttack1 || image == leftAttack2) {
				selfCenterX = worldX + gp.tileSize*3/2;
				selfCenterY = worldY + gp.tileSize/2;
				graphics2d.drawImage(image, screenX - tileSize, screenY, null);
				}
			else if (image == upAttack1 || image == upAttack2){
				selfCenterX = worldX + gp.tileSize/2;
				selfCenterY = worldY + gp.tileSize*3/2;
				graphics2d.drawImage(image, screenX, screenY - tileSize, null);
			}
			else {
				selfCenterX = worldX + gp.tileSize/2;
				selfCenterY = worldY + gp.tileSize/2;
		...
		if (skill1waiting != 0) {
			...
			if (skill1EffectiveTime >= 0) {
				if (skill1EffectiveTime % 12 < 3) {
					selfCenterX = worldX + gp.tileSize*3/2;
					selfCenterY = worldY + gp.tileSize/2;
					graphics2d.drawImage(leftAttack2, screenX - tileSize, screenY, null);
				}
				else if (skill1EffectiveTime % 12 < 6){
					selfCenterX = worldX + gp.tileSize/2;
					selfCenterY = worldY + gp.tileSize*3/2;
					graphics2d.drawImage(upAttack2, screenX, screenY - tileSize, null);
				}
				else if (skill1EffectiveTime % 12 < 9) {
					selfCenterX = worldX + gp.tileSize/2;
					selfCenterY = worldY + gp.tileSize/2;
					graphics2d.drawImage(rightAttack2, screenX, screenY, null);
				}
				else{
					selfCenterX = worldX + gp.tileSize/2;
					selfCenterY = worldY + gp.tileSize/2;
					graphics2d.drawImage(downAttack2, screenX, screenY, null);
				}
			}
